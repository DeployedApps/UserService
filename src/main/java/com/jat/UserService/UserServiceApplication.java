...
@EnableEurekaClient
@EnableFeignClients
@OpenAPIDefinition(info = @Info(title = "This is  User Service Microservices. Please Choose another microservice from dropdown [TOP RIGHT CORNER] of main Document Server.", version = "3.0", description = "USER-SERVICE contains User Information along with Hotel information which user has provided durings his stay. The API is powered by salient features of Spring Boot e.g. [resilence4j](!https://resilience4j.readme.io/docs),"+ 
