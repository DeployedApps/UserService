...
@EnableEurekaClient
@EnableFeignClients
@OpenAPIDefinition(info = @Info(title = "This is  User Microservices. Please Choose another spec from dropdown for other services from main [Document Server API Gatway](!https://document-server-production.up.railway.app/swagger-ui.html). Please find our [Registry Server](!https://serviceregitsry-production.up.railway.app/) here & exoplore our apps.", version = "3.0", description = "USER-SERVICE contains User Information along with Hotel information which user has provided durings his stay. The API is powered by salient features of Spring Boot e.g. [resilence4j](!https://resilience4j.readme.io/docs),"+ 
